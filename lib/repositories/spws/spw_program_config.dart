...
class SharedPreferenceWrapper {
  ...
  static const String globalKeyName = "spw_program_config";
    ...
    if (savedJsonString.trim() == "") {
      ...
      try {
        ...
        var resultObject = SharedPreferenceWrapperVo(
          map["pageLanguageConfigCode"],
          map["pageCountryConfigCode"],
          map["pageBrightnessThemeConfigCode"],
        );
        semaphore.release();
        return resultObject;
      } catch (e) {
  ...
  static void set(SharedPreferenceWrapperVo? value) {
    ...
    if (value == null) {
      ...
      Map<String, dynamic> map = {
        "pageLanguageConfigCode": value.pageLanguageConfigCode,
        "pageCountryConfigCode": value.pageCountryConfigCode,
        "pageBrightnessThemeConfigCode": value.pageBrightnessThemeConfigCode,
      };
...
class SharedPreferenceWrapperVo {
  ...
  SharedPreferenceWrapperVo(this.pageLanguageConfigCode,
      this.pageCountryConfigCode, this.pageBrightnessThemeConfigCode);
}
