...
// 프로그램의 언어, 국가, 밝기 모드 설정 정보를 저장합니다.
...
class SharedPreferenceWrapper {
  ...
  static const String globalKeyName = "spw_program_setting";
    ...
    if (savedJsonString.trim() == "") {
      ...
      try {
        ...
        var resultObject = SharedPreferenceWrapperVo(
          settingCountry: map["settingCountry"],
          settingLanguage: map["settingLanguage"],
          settingBrightnessMode: map["settingBrightnessMode"],
        );
        _semaphore.release();
        return resultObject;
      } catch (e) {
  ...
  static void set({required SharedPreferenceWrapperVo? value}) {
    ...
    if (value == null) {
      ...
      Map<String, dynamic> map = {
        "settingCountry": value.settingCountry,
        "settingLanguage": value.settingLanguage,
        "settingBrightnessMode": value.settingBrightnessMode,
      };
