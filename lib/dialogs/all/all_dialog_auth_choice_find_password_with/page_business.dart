      ...
      case 1: // Email
        {
          ...
          all_page_find_password_with_email.PageOutputVo? pageOutputVo =
              await _context
                  .pushNamed(all_page_find_password_with_email.pageName);
          //  종료 여부 확인
      ...
      case 2: // Phone
        {
          // 전화번호 본인 검증 화면으로 이동
          if (!_context.mounted) return;
          all_page_find_password_with_phone_number.PageOutputVo? pageOutputVo =
              await _context
                  .pushNamed(all_page_find_password_with_phone_number.pageName);
          //  종료 여부 확인
          if (pageOutputVo != null && pageOutputVo.complete) {
            if (!_context.mounted) return;
            _context.pop();
