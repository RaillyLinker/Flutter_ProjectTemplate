...
import 'pages/all/all_page_gif_sample/page_widget.dart' as all_page_gif_sample;
...
GoRouter getRouter() {
  ...
  routeList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_home.PageWidget(goRouterState: s),
  ...
  subRouteListPageAndRouterSampleList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_input_and_output_push_test.PageWidget(
                goRouterState: s),
            transitionsBuilder:
  ...
  subRouteList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_dialog_sample_list.PageWidget(goRouterState: s),
            transitionsBuilder:
  ...
  subRouteList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_dialog_animation_sample_list.PageWidget(
                goRouterState: s),
            transitionsBuilder:
  ...
  subRouteList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_auth_sample.PageWidget(goRouterState: s),
  ...
  subRouteListAuthSample.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_member_info.PageWidget(goRouterState: s),
  ...
  subRouteListAuthSample.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_membership_withdrawal.PageWidget(goRouterState: s),
            transitionsBuilder:
  ...
  subRouteList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_etc_sample_list.PageWidget(goRouterState: s),
            transitionsBuilder:
  ...
  subRouteListEtcSampleList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_gif_sample.PageWidget(goRouterState: s),
  ...
  subRouteListEtcSampleList.add(GoRoute(
      ...
      pageBuilder: (c, s) {
        return CustomTransitionPage(
            key: s.pageKey,
            child: all_page_context_menu_sample.PageWidget(goRouterState: s),
            transitionsBuilder:
