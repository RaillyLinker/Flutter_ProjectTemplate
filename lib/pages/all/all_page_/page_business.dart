...
class PageBusiness {
  ...
  final GlobalKey<page_view.SampleNumberState> sampleNumberStateGk = GlobalKey();
...
//   }
  ...
  // (화면 카운트 +1)
  void countPlus1() {
    pageViewModel.sampleNumberViewModel.sampleInt += 1;
    sampleNumberStateGk.currentState!.refresh();
  }
...
class PageViewModel {
  ...
  page_view.SampleNumberViewModel sampleNumberViewModel = page_view.SampleNumberViewModel(0);
