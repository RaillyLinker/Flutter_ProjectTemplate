...
class PageBusiness {
  ...
  Future<void> onPageDestroyAsync() async {
    // !!!페이지 종료 로직 작성!!!
    pageViewModel.urlTextEditController.dispose();
  }
...
//   }
  ...
  Future<void> launchUrlInAppAsync() async {
    String urlString = pageViewModel.urlTextEditController.text;
...
class PageViewModel {
  PageViewModel(this._context) {
    // 초기값 설정
    urlTextEditController.text = "https://google.com";
  }
  ...
  gw_page_out_frames.PageOutFrameBusiness pageOutFrameBusiness =
      gw_page_out_frames.PageOutFrameBusiness(pageTitle: "Url Launcher 샘플");

  TextEditingController urlTextEditController = TextEditingController();
...
// !!!이 페이지에서 사용할 "모든" BLoC 클래스들에 대한 Provider 객체들을 아래 리스트에 넣어줄 것!!!
  List<BlocProvider<dynamic>> blocProviders = [
    ...
    BlocProvider<BlocUrlTextField>(create: (context) => BlocUrlTextField()),
  ];
}
...
class BLocObjects {
  BLocObjects(this._context) {
    ...
    blocUrlTextField = BlocProvider.of<BlocUrlTextField>(_context);
  }
  ...
  late BlocUrlTextField blocUrlTextField;
}
