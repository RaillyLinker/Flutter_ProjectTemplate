        ...
        builder: (context) => all_dialog_loading_spinner.MainWidget(
              ...
              inputVo:
                ...
                for (Input9ListItemViewModel tec in input9List) {
                  ...
                  requestBodyStringList.add(value);
                }

                List<String>? requestBodyStringListNullable;
                if (input10List.isNotEmpty) {
                  ...
                  for (Input10ListItemViewModel tec in input10List) {
                    ...
                    requestBodyStringListNullable.add(value);
                  }
                }
                    ...
                    .postService1TkV1RequestTestPostRequestApplicationJsonAsync(
                        requestBodyVo: api_main_server
                            .PostService1TkV1RequestTestPostRequestApplicationJsonAsyncRequestBodyVo(
                                requestBodyString: input1Text,
                                requestBodyStringNullable:
                                    (input2TextFieldController.text == "")
                                        ? null
                                        : input2TextFieldController.text,
                                requestBodyInt: int.parse(input3Text),
                                requestBodyIntNullable:
                                    (input4TextFieldController.text == "")
                                        ? null
                                        : int.parse(
                                            input4TextFieldController.text),
                                requestBodyDouble: double.parse(input5Text),
                                requestBodyDoubleNullable:
                                    (input6TextFieldController.text == "")
                                        ? null
                                        : double.parse(
                                            input6TextFieldController.text),
                                requestBodyBoolean: input7Value,
                                requestBodyBooleanNullable: input8Value,
